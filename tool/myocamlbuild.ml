(* OASIS_START *)
(* DO NOT EDIT (digest: 35481ca17333148dd8939cd5c15a83e1) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("classifier.ida", ["src/ida"], []);
          ("classifier.data", ["src/data"], []);
          ("weka", ["src/weka"], []);
          ("classifier.learning", ["src/learning"], []);
          ("classifier.block", ["src/block"], []);
          ("classifier.util", ["src/util"], []);
          ("lang", ["src/lang"], [])
       ];
     lib_c = [];
     flags = [];
     includes =
       [
          ("src/util", ["src/block"; "src/data"; "src/ida"]);
          ("src/learning", ["src/data"; "src/ida"; "src/weka"]);
          ("src/lang", ["src/data"; "src/ida"; "src/util"]);
          ("src/block", ["src/ida"]);
          ("src",
            ["src/block"; "src/data"; "src/ida"; "src/lang"; "src/util"])
       ]
  }
  ;;
