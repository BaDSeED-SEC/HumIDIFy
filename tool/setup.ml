...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9e51d734872f59a41e76189d46f18786) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["IDALink"];
                      lib_pack = false;
                      lib_internal_modules = ["IDALinkArch"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["DataAnalysis"];
                      lib_pack = false;
                      lib_internal_modules = ["DataExtraction"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Weka"];
                      lib_pack = false;
                      lib_internal_modules = ["WekaSystem"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "classifier.data";
                           InternalLibrary "classifier.ida";
                           FindlibPackage ("unix", None);
                           InternalLibrary "weka"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("core_kernel", None);
                           FindlibPackage ("elf", None);
                           InternalLibrary "classifier.block";
                           InternalLibrary "classifier.data";
                           InternalLibrary "classifier.ida"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("strings", None);
                           InternalLibrary "classifier.data";
                           InternalLibrary "classifier.util"
                        ];
                      bs_build_tools =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "profile.ml"});
               Executable
                 ({
                     cs_name = "fun-file";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "classify.ml"});
               Executable
                 ({
                     cs_name = "classifier";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "processClassify.ml"});
               Executable
                 ({
                     cs_name = "process-sort";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "processSort.ml"});
               Executable
                 ({
                     cs_name = "rebuild";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "rebuild.ml"})
            ];
     ...
     oasis_digest = Some "\012\237\153\246Up9\217\229Oj'WW\027I";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
